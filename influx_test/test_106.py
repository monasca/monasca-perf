...
class test_106(TestBase):
    def run(self):
        ...
        ipw.start(1,2,'stopInflux',self.name)
        self.env.startInflux(2)
        ...
        return ["PASS",""]
    def desc(self):
        return 'Shut down nodes 2 & 3. Bring back up node 2, then 3. Start writing to node 1 while bringing down node 2. Bring back up 2. Query'
