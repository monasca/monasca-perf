...
class test_304(TestBase):
    def run(self):
        ...
        ipw.start(1,3,'killInflux',self.name)
        ...
        return ["PASS",""]
    def desc(self):
        return 'Kill node 3. Fire off multiple writes while shutting down the node. Bring back up and query from that node'
