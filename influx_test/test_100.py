...
#This is the start of the dead node tests (100-199)
class test_100(TestBase):
    def run(self):
        ...
        return ["PASS",""]
    def desc(self):
        return 'Shut down node 3. Fire off several different writes. Bring back up and query from that node'
